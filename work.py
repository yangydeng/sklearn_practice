...
def combine_all_files(*files):
    ...
    all_tmp = []
    all_title = []
    all_file_title = ["2014年度创新研究群体及国家杰出青年科学基金项目（信息领域）评审会专家名单","2014年度面上基金、青年基金及地区基金项目（信息领域）评审会专家名单",\
    "2014年度信息科学部海外及港澳学者合作研究基金、重点国际(地区)合作与交流项目、民航联合基金评审会专家名单","2014年度信息科学部重大项目评审会专家名单",\
    "2014年度优秀青年科学基金项目（信息领域）评审会专家名单","2014年度重点基金项目（信息领域）评审会专家名单","2015年度创新研究群体及国家杰出青年科学基金项目（信息领域）评审会专家公示名单","2015年度优秀青年基金项目（信息领域）评审会专家公示名单","undone会评专家名单"]
    for file in files:
...
#doc
f1 = pd.read_excel("国家自然科学基金委 信息学部_会评专家名单/面上基金、青年基金、重点基金、优青、杰青/excels/2014年度创新研究群体及国家杰出青年科学基金项目（信息领域）评审会专家名单.xlsx",names=[i for i in range(5)])
f2 = pd.read_excel("国家自然科学基金委 信息学部_会评专家名单/面上基金、青年基金、重点基金、优青、杰青/excels/2014年度面上基金、青年基金及地区基金项目（信息领域）评审会专家名单.xlsx",names=[i for i in range(10)])
f3 = pd.read_excel("国家自然科学基金委 信息学部_会评专家名单/面上基金、青年基金、重点基金、优青、杰青/excels/2014年度信息科学部海外及港澳学者合作研究基金、重点国际(地区)合作与交流项目、民航联合基金评审会专家名单.xlsx",names=[i for i in range(4)])
f4 = pd.read_excel("国家自然科学基金委 信息学部_会评专家名单/面上基金、青年基金、重点基金、优青、杰青/excels/2014年度信息科学部重大项目评审会专家名单.xlsx",names=[i for i in range(10)])
f5 = pd.read_excel("国家自然科学基金委 信息学部_会评专家名单/面上基金、青年基金、重点基金、优青、杰青/excels/2014年度优秀青年科学基金项目（信息领域）评审会专家名单.xlsx",names=[i for i in range(5)])
f6 = pd.read_excel("国家自然科学基金委 信息学部_会评专家名单/面上基金、青年基金、重点基金、优青、杰青/excels/2014年度重点基金项目（信息领域）评审会专家名单.xlsx",names=[i for i in range(7)])
f7 = pd.read_excel("国家自然科学基金委 信息学部_会评专家名单/面上基金、青年基金、重点基金、优青、杰青/excels/2015年度创新研究群体及国家杰出青年科学基金项目（信息领域）评审会专家公示名单.xlsx",names=[i for i in range(5)])
f8 = pd.read_excel("国家自然科学基金委 信息学部_会评专家名单/面上基金、青年基金、重点基金、优青、杰青/excels/2015年度优秀青年基金项目（信息领域）评审会专家公示名单.xlsx",names=[i for i in range(10)])
f8 = pd.read_excel("国家自然科学基金委 信息学部_会评专家名单/面上基金、青年基金、重点基金、优青、杰青/excels/undone会评专家名单.xlsx",names=[1,2])

all_names_doc,all_titles_doc = combine_all_files(f1,f2,f3,f4,f5,f6,f7,f8)
